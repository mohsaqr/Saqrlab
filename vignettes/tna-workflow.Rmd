...
remotes::install_github("mohsaqr/Sonnet@cograph_merged")

Data <- Saqrlab::simulate_onehot_data()

library(tna)
prepare_data(group_regulation_long, Action="Action", )




onehot(Data, cols =6:14)

tna::import_onehot(Data, cols =6:14, window_size = 3, )
...
| Grid simulation | `generate_param_grid()`, `run_grid_simulation()` |
