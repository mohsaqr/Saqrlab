...
This vignette covers bootstrap analysis and power analysis for TNA
studies using Saqrlab. You’ll learn how to:
...
Bootstrap helps answer: - How stable are my network estimates? - What’s
the confidence interval for edge weights? - Are my centrality rankings
reliable?

### Power Analysis

Power analysis helps answer: - How many sequences do I need for reliable
results? - What sequence length is sufficient? - How do sample size and
network size interact?
...
| Function | Purpose |
|----|----|
| [`run_bootstrap_simulation()`](https://pak.dynasite.org/Saqrlab/reference/run_bootstrap_simulation.md) | Bootstrap analysis |
| [`run_bootstrap_iteration()`](https://pak.dynasite.org/Saqrlab/reference/run_bootstrap_iteration.md) | Evaluate bootstrap results |
| [`run_grid_simulation()`](https://pak.dynasite.org/Saqrlab/reference/run_grid_simulation.md) | Parameter grid simulation |
| [`summarize_grid_results()`](https://pak.dynasite.org/Saqrlab/reference/summarize_grid_results.md) | Analyze grid output |
| [`generate_param_grid()`](https://pak.dynasite.org/Saqrlab/reference/generate_param_grid.md) | Create parameter combinations |
| [`summarize_simulation()`](https://pak.dynasite.org/Saqrlab/reference/summarize_simulation.md) | Summary statistics |

### Recommended Workflow

1.  **Define research question**: What parameters affect recovery?
2.  **Create parameter grid**: Use
    [`generate_param_grid()`](https://pak.dynasite.org/Saqrlab/reference/generate_param_grid.md)
3.  **Run simulations**: Use
